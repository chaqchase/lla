...
set edit:completion:arg-completer[lla] = {|@words|
    ...
    var completions = [
        &'lla'= {
            ...
            cand --hyperlink 'Emit OSC 8 file hyperlinks (always, auto, never)'
            ...
            cand --show-symlinks 'Include symlinks whose targets match --dirs-only or --files-only'
            cand --no-dirs 'Hide directories'
            cand --no-files 'Hide regular files'
            cand --no-symlinks 'Hide symbolic links'
            cand -X 'Display metadata from symbolic-link targets'
            cand --dereference 'Display metadata from symbolic-link targets'
            cand --no-symlink-target 'Do not display symbolic-link targets after file names'
            ...
            cand -i 'Show inode numbers in long format'
            cand --inode 'Show inode numbers in long format'
            cand -H 'Show hard-link counts in long format'
            cand --links 'Show hard-link counts in long format'
            cand --allocated-size 'Show allocated filesystem size in long format'
            cand -@ 'Show extended attribute names and sizes in long format'
            cand --extended 'Show extended attribute names and sizes in long format'
            cand -Z 'Show ACL or SELinux security context in long format'
            cand --context 'Show ACL or SELinux security context in long format'
            cand -M 'Show source, mount point, and filesystem in long format'
            cand --mounts 'Show source, mount point, and filesystem in long format'
