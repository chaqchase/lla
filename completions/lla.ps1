...
Register-ArgumentCompleter -Native -CommandName 'lla' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'lla' {
            ...
            [CompletionResult]::new('--hyperlink', 'hyperlink', [CompletionResultType]::ParameterName, 'Emit OSC 8 file hyperlinks (always, auto, never)')
            ...
            [CompletionResult]::new('--show-symlinks', 'show-symlinks', [CompletionResultType]::ParameterName, 'Include symlinks whose targets match --dirs-only or --files-only')
            ...
            [CompletionResult]::new('-X', 'X', [CompletionResultType]::ParameterName, 'Display metadata from symbolic-link targets')
            [CompletionResult]::new('--dereference', 'dereference', [CompletionResultType]::ParameterName, 'Display metadata from symbolic-link targets')
            [CompletionResult]::new('--no-symlink-target', 'no-symlink-target', [CompletionResultType]::ParameterName, 'Do not display symbolic-link targets after file names')
            ...
            [CompletionResult]::new('-i', 'i', [CompletionResultType]::ParameterName, 'Show inode numbers in long format')
            [CompletionResult]::new('--inode', 'inode', [CompletionResultType]::ParameterName, 'Show inode numbers in long format')
            [CompletionResult]::new('-H', 'H', [CompletionResultType]::ParameterName, 'Show hard-link counts in long format')
            [CompletionResult]::new('--links', 'links', [CompletionResultType]::ParameterName, 'Show hard-link counts in long format')
            [CompletionResult]::new('--allocated-size', 'allocated-size', [CompletionResultType]::ParameterName, 'Show allocated filesystem size in long format')
            [CompletionResult]::new('-@', '@', [CompletionResultType]::ParameterName, 'Show extended attribute names and sizes in long format')
            [CompletionResult]::new('--extended', 'extended', [CompletionResultType]::ParameterName, 'Show extended attribute names and sizes in long format')
            [CompletionResult]::new('-Z', 'Z', [CompletionResultType]::ParameterName, 'Show ACL or SELinux security context in long format')
            [CompletionResult]::new('--context', 'context', [CompletionResultType]::ParameterName, 'Show ACL or SELinux security context in long format')
            [CompletionResult]::new('-M', 'M', [CompletionResultType]::ParameterName, 'Show source, mount point, and filesystem in long format')
            [CompletionResult]::new('--mounts', 'mounts', [CompletionResultType]::ParameterName, 'Show source, mount point, and filesystem in long format')
